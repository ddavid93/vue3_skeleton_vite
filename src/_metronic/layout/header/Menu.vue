...
import MainMenuConfig from "@/_metronic/core/config/MainMenuConfig";
import {headerMenuIcons} from "@/_metronic/core/helpers/config";
import {version} from "@/_metronic/core/helpers/documentation";
